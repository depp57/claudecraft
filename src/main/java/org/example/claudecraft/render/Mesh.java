 ...
 *
 * <p>Vertex layout is interleaved {@code vec3 position, vec3 color}, matching
 * attribute locations 0 and 1 of {@code basic.vert}. The layout will grow
 * (UVs, normals/light) once the texture atlas and chunk meshing land.
 *
